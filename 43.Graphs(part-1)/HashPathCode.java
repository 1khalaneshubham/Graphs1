...
public class HashPathCode {
    ...
    public static void BSF(ArrayList<Edge>[] graph){  // TC-O(n)
    ...
    public static void DSF(ArrayList<Edge>[] graph, int curr, boolean vis[]){
        // visit
        System.out.print(curr + " ");
        vis[curr] = true;
